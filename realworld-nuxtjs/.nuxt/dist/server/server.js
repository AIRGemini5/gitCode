...
/* harmony default export */ __webpack_exports__["a"] = (({
  ...
  request.interceptors.request.use(function (config) {
    console.log('111'); // Do something before request is sent
    // 请求就会经过这里
...
const actions = {
  ...
  nuxtServerInit({
    ...
    if (req.headers.cookie) {
      ...
      try {
        user = JSON.parse(parsed.user); // let aa = JSON.parse(user.user)
        // user = parsed.user
...
const _e040058e = () => interopDefault(__webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 31)));

const _2c5d2eae = () => interopDefault(__webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 29)));

const _5f80ef7a = () => interopDefault(__webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, 30)));

const _5c29c97a = () => interopDefault(__webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, 32)));

const _8b61131c = () => interopDefault(__webpack_require__.e(/* import() */ 7).then(__webpack_require__.bind(null, 33)));

const _f7ddb908 = () => interopDefault(__webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(null, 34)));

const _42f40cc7 = () => interopDefault(__webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 28)));
